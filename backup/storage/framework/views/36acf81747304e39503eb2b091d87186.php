      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 col-12 mx-auto">
            ...
            <small class="text-home "><i class="bi bi-info-circle"></i> <?php echo e($info); ?></small>
            ...
            <table class="table table-striped text-home">
              ...
              <tbody>
                ...
                <tr>
                  <td scope="row">
                    <button type="button" class="text-black" data-toggle="modal" data-target="#exampleModalCenter<?php echo e($pres->id); ?>" style="border: 0;background:none">
                  ...
                  <td><span class=" badge rounded-pill bg-primary">
                      ...
                      <button type="button" class="  text-white" data-toggle="modal" data-target="#exampleModalCenter<?php echo e($pres->id); ?>" style="border: 0;background:none">
                        Rp. <?php echo e($pres->fee); ?>
...
<!-- Modal -->
<?php $__currentLoopData = $presensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="exampleModalCenter<?php echo e($pres->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input type="hidden" name="presensi_id" value="<?php echo e($pres->id); ?>">
...
</html><?php /**PATH /Users/macbook/Documents/aplikasi/crew_bk/resources/views/fee/home.blade.php ENDPATH**/ ?>