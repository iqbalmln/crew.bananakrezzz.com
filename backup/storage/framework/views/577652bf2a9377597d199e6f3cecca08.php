                ...
                <div class="container mb-3">
                    <form action="/search_kartu" method="GET">
                        <div class="input-group ">
                            <input type="text" class="form-control" value="<?php echo e($keyword ?? ''); ?>" name="keyword">
                ...
                <div class="card card-body">
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $kartu_aktif->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">
                                        <?php echo e($presensi->where('card_id', $user->id)->count()); ?>
                                    ...
                                    <td class="border-bottom-0">
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#update<?php echo e($user->id); ?>">
                                            <i class="bi bi-arrow-clockwise"></i>
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="update<?php echo e($user->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/act.update.kartu" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="<?php echo e($user->nomor); ?>" name="nomor">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  value="<?php echo e($user->nik); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Nama</label>
                                                                <input type="text" class="form-control"  value="<?php echo e($user->nama); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Asal</label>
                                                                <input type="text" class="form-control"  value="<?php echo e($user->asal); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Jenis Kelamin</label>
                                                                <input type="text" class="form-control"  value="<?php echo e($user->jk); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">HP</label>
                                                                <input type="text" class="form-control"  value="<?php echo e($user->hp); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  value="<?php echo e($presensi->where('card_id', $user->id)->count()); ?>" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Ditambahkan Pada</label>
                                                                <input type="text" class="form-control"  value="<?php echo e($user->created_at); ?>" readonly>
                                                            </div>
...
<?php echo $__env->make('staf.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1567367/public_html/crew.bananakrezzz.com/resources/views/staf/users/update_kartu.blade.php ENDPATH**/ ?>