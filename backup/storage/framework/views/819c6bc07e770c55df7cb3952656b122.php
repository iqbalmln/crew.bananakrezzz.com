  ...
  <main>
    ...
    <div class="wrapper">
      ...
      <div id="content">
              ...
              <div class="col-lg-8 col-12 mx-auto">
                ...
                <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search" action="/cari_kartu_act">
                  ...
                  <div class="input-group input-group-lg">
                    ...
                    <input name="nama" type="search" class="form-control" id="nama" placeholder="Tulis nama Crew / Nomor Kartu / NIK ..." value="<?php echo e(isset($nama) ? $nama : ''); ?>" aria-label="Search" autofocus required>
        ...
        <?php if(session()->has('sudah_regis')): ?>
        ...
        <?php if(session()->has('berhasil_regis')): ?>
        <section class="explore-section section-padding" id="section_2">
          <div class="container">
            <div class="row">
        ...
        <section class="faq-section section-padding">
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

              <div class="col-lg-4 col-12 mb-3">
                <a href="/detail_card?nomor=<?php echo e($crew->nomor); ?>">
                  <div class="custom-block custom-block-overlay">
                    <div class="d-flex flex-column h-100">
                      ...
                      <div class="custom-block-overlay-text d-flex">
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                ...
                                <td class="text-white"><?php echo e($crew->nomor); ?></td>
                              </tr>
                              <tr>
                                <th class="text-white">NIK</th>
                                <td class="text-white"></td>
                                <td class="text-white"><?php echo e($crew->nik); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="text-white"></td>
                                <td class="text-white"><?php echo e($crew->jk); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="text-white"></td>
                                <td class="text-white"><?php echo e($crew->creatd_at); ?></td>
                              </tr>
                        ...
                        <?php $__currentLoopData = $presensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pren): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($crew->id == $pren->card_id): ?>
                        <?php
                        $lastTgl = $pren->tgl;
                        ?>
                        <?php endif; ?>
                        ...
                        <?php if(!is_null($lastTgl)): ?>
                        <small class="text-primary">*Terakhir melakukan presensi pada <?php echo e($lastTgl); ?></small>
                        <?php else: ?>
...
</html><?php /**PATH /home/u1567367/public_html/crew.bananakrezzz.com/resources/views/card/cari_kartu.blade.php ENDPATH**/ ?>