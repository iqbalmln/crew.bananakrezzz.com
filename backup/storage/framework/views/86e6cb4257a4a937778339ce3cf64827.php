...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    <!-- Sidebar Start -->
    <?php echo $__env->make('staf.layout.side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--  Sidebar End -->
    <!--  Main wrapper -->
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <?php echo $__env->yieldContent('staf'); ?>
  ...
  <div class="modal fade" id="dlaporan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Formulir -->
          <form method="GET" action="<?php echo e(url('/download_presensi')); ?>" id="downloadForm">
            <?php echo csrf_field(); ?>
            <div class="form-group">
...
<script>
      document.getElementById('downloadForm').addEventListener('submit', function (event) {
        ...
        var actionUrl = isAlternatifChecked ? "<?php echo e(url('/dpresensi')); ?>" : "<?php echo e(url('/download_presensi')); ?>";
...
</html><?php /**PATH /home/u1567367/public_html/crew.bananakrezzz.com/resources/views/staf/layout/main.blade.php ENDPATH**/ ?>