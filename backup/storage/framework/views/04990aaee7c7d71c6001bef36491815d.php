    ...
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            ...
            <div class="card-body p-4">
                ...
                <?php if(session()->has('hapus_kartu')): ?>
                    ...
                    <div class="card card-body">
                        <div class="table-responsive">
                            <table class="table text-nowrap mb-0 align-middle">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $kartu_aktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                    ...
                    <div class="card card-body">
                        <div class="table-responsive">
                            <table class="table text-nowrap mb-0 align-middle">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $kartu_pasif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="border-bottom-0">
                                            <p class="mb-0 fw-normal">
                                                <?php echo e($user->nomor); ?>
                                        ...
                                        <td>
                                            <a href="/hapus.kartu?id=<?php echo e($user->id); ?>" class="btn btn-danger btn-sm" >
...
<?php echo $__env->make('staf.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1567367/public_html/crew.bananakrezzz.com/resources/views/staf/users/kartu.blade.php ENDPATH**/ ?>