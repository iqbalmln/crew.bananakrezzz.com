      ...
      <div class="modal-body">
        <form method="post" action="/cerew_update">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nik" value="<?php echo e($crew->nik); ?>" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="hp" value="<?php echo e($crew->hp); ?>" required>
          </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"></script><?php /**PATH /home/u1567367/public_html/crew.bananakrezzz.com/resources/views/home/presensi.blade.php ENDPATH**/ ?>